...
content_path = tf.keras.utils.get_file('lincoln.jpg', path + 'lincoln.jpg')
style_path = tf.keras.utils.get_file('homer.jpg', path + 'homer.jpg')
...
tensor_to_image(style_image).show()
...
myImg = tensor_to_image(stylized_image)
myImg.show()
